-- SAYU Art Counselor Database Schema
...
CREATE TABLE IF NOT EXISTS art_journals (
  ...
  -- AI Enrichment
  emotion_vector TEXT, -- pgvector 확장 설치 후 vector(768)로 변경 가능
  writing_style JSONB,
...
-- user_art_journeys 정책: 자신의 여정만 접근
...
-- daily_art_presentations 정책: 자신의 기록만 보기
...
INSERT INTO artworks (id, title, title_en, artist, artist_en, year, medium, dimensions, location, style, image_url) VALUES
  ...
  ('birth-of-venus', '비너스의 탄생', 'The Birth of Venus', '산드로 보티첼리', 'Sandro Botticelli', 1485, '템페라', '172.5 × 278.9 cm', '우피치 갤러리', '초기 르네상스', 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Sandro_Botticelli_-_La_nascita_di_Venere_-_Google_Art_Project_-_edited.jpg/1280px-Sandro_Botticelli_-_La_nascita_di_Venere_-_Google_Art_Project_-_edited.jpg'),

  ('night-watch', '야경', 'The Night Watch', '렘브란트', 'Rembrandt', 1642, '유화', '363 × 437 cm', '레이크스 미술관', '바로크', 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/The_Night_Watch_-_HD.jpg/1280px-The_Night_Watch_-_HD.jpg'),

  ('wanderer', '안개 바다 위의 방랑자', 'Wanderer above the Sea of Fog', '카스파르 다비트 프리드리히', 'Caspar David Friedrich', 1818, '유화', '98.4 × 74.8 cm', '함부르크 미술관', '낭만주의', 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg/800px-Caspar_David_Friedrich_-_Wanderer_above_the_sea_of_fog.jpg'),

  ('luncheon', '뱃놀이 일행의 오찬', 'Luncheon of the Boating Party', '피에르 오귀스트 르누아르', 'Pierre-Auguste Renoir', 1881, '유화', '129.9 × 172.7 cm', '필립스 컬렉션', '인상주의', 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Pierre-Auguste_Renoir_-_Luncheon_of_the_Boating_Party_-_Google_Art_Project.jpg/1280px-Pierre-Auguste_Renoir_-_Luncheon_of_the_Boating_Party_-_Google_Art_Project.jpg'),

  ('dance-class', '무용 수업', 'The Dance Class', '에드가 드가', 'Edgar Degas', 1874, '유화', '85 × 75 cm', '오르세 미술관', '인상주의', 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Edgar_Degas_-_The_Dance_Class_-_Google_Art_Project.jpg/1024px-Edgar_Degas_-_The_Dance_Class_-_Google_Art_Project.jpg')
ON CONFLICT (id) DO NOTHING;

-- 완료 메시지
DO $$
BEGIN
  RAISE NOTICE '✅ SAYU Art Counselor 테이블 생성 완료!';
  RAISE NOTICE '📊 생성된 테이블:';
  RAISE NOTICE '  - artworks (10개 작품)';
  RAISE NOTICE '  - art_journals (감상 기록)';
