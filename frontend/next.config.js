...
const nextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      // Korean museum/gallery image domains (exhibition pipeline)
      { protocol: 'https', hostname: '**.museum.go.kr' },
      ...
      { protocol: 'http', hostname: '**.museum.go.kr' },
      // Gallery scraper image domains
      { protocol: 'https', hostname: 'art-map.co.kr' },
      { protocol: 'https', hostname: 'gagosian.com' },
      { protocol: 'https', hostname: 'www.gagosian.com' },
      { protocol: 'https', hostname: 'lisson-art.s3.amazonaws.com' },
      { protocol: 'https', hostname: 'www.perrotin.com' },
      ...
      { protocol: 'https', hostname: 'images.e-flux.com' },
