...
const mockUsersData = [
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1566492031773-4f4e44671857?w=800&h=800&fit=crop&crop=face',
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&h=800&fit=crop&crop=face',
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=800&h=800&fit=crop&crop=face',
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1514315384763-ba401779410f?w=800&h=800&fit=crop&crop=face',
  ...
  {
    id: '6',
    nickname: 'marcus.gallery',
    age: 31,
    personalityType: 'SREC',
    location: 'Seoul, Hannam',
    bio_en: 'Expat art collector based in Seoul. Fascinated by the Korean art scene. Let\'s discover emerging artists together!',
    bio_ko: '서울에 거주하는 외국인 아트 컬렉터. 한국 미술계에 매료되었어요. 함께 신진 작가를 발굴해봐요!',
  ...
  {
    id: '8',
    nickname: 'emma.artlover',
    age: 28,
    personalityType: 'LRMC',
    location: 'Seoul, Yeonnam',
    bio_en: 'Designer from Berlin, now exploring Seoul\'s vibrant art scene. Love spatial installations and immersive experiences.',
    bio_ko: '베를린에서 온 디자이너, 서울의 활기찬 아트씬을 탐험 중. 공간 설치와 몰입형 경험을 좋아해요.',
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?w=800&h=800&fit=crop&crop=face',
  ...
  },
  {
    ...
    avatar: 'https://images.unsplash.com/photo-1545167622-3a6ac756afa4?w=800&h=800&fit=crop&crop=face',
