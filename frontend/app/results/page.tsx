    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-neutral-200 sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 py-3 flex justify-center items-center">
          <h1 className="font-serif text-lg font-medium text-black">
      ...
      <section className="max-w-4xl mx-auto px-4 pt-2 pb-4">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-serif font-bold text-black mb-3"
          >
          ...
          <motion.p
            ...
            className="text-lg text-black max-w-3xl mx-auto subtitle-text"
            style={{
      ...
      <section className="max-w-4xl mx-auto px-4 py-6">
        ...
        >
          {/* 당신과 연결된 아티스트 섹션 */}
          <div className="mb-8">
            <h2 className="text-xl sm:text-2xl font-serif font-bold text-center text-black mb-4">
              ...
              >
                ...
                <div className="p-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="text-black hover:text-neutral-600 text-sm font-medium">
              ...
              >
                {personality.strengths.map((strength: any, index: number) => (
                  <motion.div
                    ...
                    className="flex gap-2 sm:gap-4 p-2 sm:p-3 rounded-lg hover:bg-amber-50 transition-colors"
                  >
                    <div className="text-xl sm:text-2xl flex-shrink-0 mt-0.5">{strength.icon}</div>
                    <div className="flex-1 min-w-0">
                      <h4 className="font-semibold text-black mb-0.5 sm:mb-1 text-sm sm:text-base">
              ...
              >
                {(language === 'ko' ? sayuType.challenges : sayuType.challengesEn).map((challenge, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: index * 0.1 }}
                    className="flex items-start gap-2 sm:gap-4 p-2 sm:p-3 rounded-lg hover:bg-orange-50 transition-colors"
                  >
                    <div className="text-xl sm:text-2xl flex-shrink-0 mt-0.5">💡</div>
                    <div className="flex-1 min-w-0">
                      <h4 className="text-black text-xs sm:text-sm leading-relaxed">{challenge}</h4>
                    </div>
                  </motion.div>
                ))}
              </motion.div>
              ...
              >
                {personality.growth.map((growthItem: any, index: number) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: index * 0.1 }}
                    className="flex gap-2 sm:gap-4 p-2 sm:p-3 rounded-lg hover:bg-green-50 transition-colors"
                  >
      ...
      <section className="max-w-4xl mx-auto px-4 py-8">
        <motion.div
          ...
          className="text-center"
        >
          <p className="text-sm sm:text-lg text-neutral-600 italic">
      ...
      {true ? ( // Temporarily always show for debugging
        <section id="signup-cta" className="bg-neutral-50 py-8 sm:py-12 mt-6 sm:mt-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <h2 className="text-xl sm:text-3xl font-serif font-bold text-black mb-2 sm:mb-4">
              {language === 'ko'
                ? '결과를 저장하시겠어요?'
                : 'Save Your Results?'}
            </h2>
            <p className="text-sm sm:text-lg text-black mb-4 sm:mb-8 max-w-2xl mx-auto">
              {language === 'ko'
                ? (
                  <>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-6 max-w-3xl mx-auto mb-4 sm:mb-8">
              <div className="text-center p-2 sm:p-4">
                ...
                <p className="text-[10px] sm:text-sm text-neutral-600 hidden sm:block">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pb-4">
              ...
              <button
                ...
                className="hidden sm:inline-flex px-8 py-4 border-2 border-black text-black rounded-lg hover:bg-black hover:text-white transition-colors font-medium text-lg items-center justify-center"
              >
