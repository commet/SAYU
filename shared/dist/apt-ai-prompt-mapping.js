...
exports.APT_PROMPT_PROFILES = exports.ART_STYLES = void 0;
exports.generateArtProfilePrompt = generateArtProfilePrompt;
exports.getRecommendedStylesForAPT = getRecommendedStylesForAPT;
exports.getArtProfileDescription = getArtProfileDescription;
// 5가지 핵심 아트 스타일 (MVP)
exports.ART_STYLES = {
    impressionism: {
        id: 'impressionism',
 ...
 */
function generateArtProfilePrompt(aptCode, artStyleId, gender = 'neutral') {
    const aptProfile = exports.APT_PROMPT_PROFILES[aptCode];
    const artStyle = exports.ART_STYLES[artStyleId];
 ...
 */
function getRecommendedStylesForAPT(aptCode) {
 ...
 * 결과 카드용 짧은 설명 생성
 */
function getArtProfileDescription(aptCode, artStyleId, locale = 'ko') {
    const descriptions = {
        LAEF: {
            ko: {
...
exports.default = {
    ART_STYLES: exports.ART_STYLES,
    APT_PROMPT_PROFILES: exports.APT_PROMPT_PROFILES,
